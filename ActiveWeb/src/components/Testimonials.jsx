    ...
    <div className='mb-10'>
        ...
        className="mySwiper text-center mt-20"
          >
              ...
              <SwiperSlide ><img src={john} alt="" className='w-[50px] h-[50px] ml-[820px] rounded-full ' />
                  <h1 className='pt-4 text-xl font-semibold'>John</h1>
              <p className='w-[600px] ml-[520px] mt-2'>“There live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.”
                  </p>
              </SwiperSlide>
              <SwiperSlide><img src={winston} alt="" className='w-[50px] h-[50px] ml-[810px] rounded-full ' />
              <h1 className='pt-4 text-xl font-semibold'>Winston</h1>
              <p className='w-[600px] ml-[520px] mt-2'>“There live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.”
                  </p></SwiperSlide>
              <SwiperSlide><img src={clare} alt="" className='w-[50px] h-[50px] ml-[810px] rounded-full ' />
              <h1 className='pt-4 text-xl font-semibold'>Clare</h1>
              <p className='w-[600px] ml-[520px] mt-2'>“There live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.”
                  </p></SwiperSlide>
              <SwiperSlide className='mb-10'><img src={steven} alt="" className='w-[50px] h-[50px] ml-[810px] rounded-full ' />
